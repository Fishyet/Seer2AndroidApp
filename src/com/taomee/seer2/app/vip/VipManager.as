...
public class VipManager extends BaseBean {
    ...
    public static function entryBBS():void {
        ...
        var _loc3_:* = "http://bbs.61.com/checksession/" + "?username=" + _loc2_ + "&gid=" + ClientConfig.productID + "&session=" + GlobalsManager.session + "&fid=37";
    ...
    public static function appointBBS(param1:uint):void {
        ...
        var _loc4_:String = "http://bbs.61.com/checksession/" + "?username=" + _loc3_ + "&gid=" + ClientConfig.productID + "&session=" + GlobalsManager.session + "&fid=37" + "&tid=" + param1;
        navigateToURL(new URLRequest(_loc4_), "_blank");
    }
    ...
    public static function entryBBSCheck():void {
        navigateToURL(new URLRequest("http://dc.61.com/Question/realQ?qn_id=29"), "_blank");
    }

...
public class Fighter extends AnimateElement {
    ...
    private function playDefAction():void {
        var _loc1_:int = this._fighterInfo.hp;
        var _loc2_:int = this._fighterTurnResultInfo.hp;
        var _loc3_:int = this._fighterTurnResultInfo.maxHp;
        if (_loc2_ == 0) {
    ...
    private function playSkillEffect(param1:int):void {
        if (this._activeSkillEffect && contains(this._activeSkillEffect)) {

...
import com.taomee.seer2.app.config.FightDecorationConfig;
...
public class FindDifferentRewrite {
    ...
    public function sendAnswer(fakeHash:String, successCallback:Function, errorCallback:Function):void {
        ...
        if (FightDecorationConfig.getInfo(fakeHash) != null) {
            var answer:uint = FightDecorationConfig.getInfo(fakeHash).answer;

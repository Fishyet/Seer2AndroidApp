...
class NumMovePlay extends Sprite {
    ...
    public function NumMovePlay(param1:String, param2:String, param3:String, param4:int) {
        ...
        switch (param3) {
            case com.taomee.seer2.app.utils.NumberPlayUtil.PATH_UP:
                ...
                break;
            case com.taomee.seer2.app.utils.NumberPlayUtil.PATH_DOWN:
                ...
                break;
            case com.taomee.seer2.app.utils.NumberPlayUtil.PATH_LEFT:
                TweenLite.to(this._sprite, 3, {
                    "x": -30,
                    "ease": Expo.easeOut,
                    "onComplete": this.onAnimateComplete
                ...
                break;
            case com.taomee.seer2.app.utils.NumberPlayUtil.PATH_RIGHT:
                TweenLite.to(this._sprite, 3, {
                    "x": 30,
                    "ease": Expo.easeOut,
                    "onComplete": this.onAnimateComplete

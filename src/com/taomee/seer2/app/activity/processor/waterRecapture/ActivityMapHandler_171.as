...
package com.taomee.seer2.app.activity.processor.waterRecapture
{
   ...
   public class ActivityMapHandler_171 extends WaterRecaptureMapHandler
   {
      ...
      private function generateNpcDefinition(param1:uint, param2:uint) : NpcDefinition
      {
         ...
         if(param1 == GUARD_ID)
         {
            _loc3_ = <npc id="40" resId="40" name="紫电卫兵" dir="0" width="25" height="90" pos="670,280" actorPos="650,320" path=""><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[缇娜队长会好好修理你们！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else
         {
            _loc3_ = <npc id="41" resId="41" name="紫电士官" dir="0" width="25" height="90" pos="670,280" actorPos="650,320" path=""><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[缇娜队长会好好修理你们！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }

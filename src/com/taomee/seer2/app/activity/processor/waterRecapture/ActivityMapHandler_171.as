...
public class ActivityMapHandler_171 extends WaterRecaptureMapHandler {
    ...
    private function initNpcDefinition():XML {
        ...
        if (this._currentBossId == OFFICER_ID) {
            ...
            _loc1_ =
                    <npc id="39" resId="39" name="缇娜" dir="0" width="25" height="160" pos="630,280" actorPos="650,320"
                         path="">
                        <dialog npcId="39" npcName="缇娜" transport="1,300,400">
                            <branch id="default">
                                <node emotion="0"><![CDATA[真是值得钦佩,我很久没有这么认真过了,紫电就归你了！]]></node>
                                <reply action="close" params="award"><![CDATA[那我就收下了！]]></reply>
                            </branch>
                        </dialog>
                        <eventHandler>
                            <mouseOver>
                                <HandlerShowNpcSlogan><![CDATA[一切都是徒劳！]]></HandlerShowNpcSlogan>
                            </mouseOver>
                        </eventHandler>
                    </npc>;
        } else {
    ...
    private function generateNpcDefinition(param1:uint, param2:uint):NpcDefinition {
        var _loc3_:XML = null;
        if (param1 == GUARD_ID) {
            _loc3_ = <npc id="40" resId="40" name="紫电卫兵" dir="0" width="25" height="90" pos="670,280"
                          actorPos="650,320" path="">
                <eventHandler>
                    <mouseOver>
                        <HandlerShowNpcSlogan><![CDATA[缇娜队长会好好修理你们！]]></HandlerShowNpcSlogan>
                    </mouseOver>
                </eventHandler>
            </npc>;
        } else {
            _loc3_ = <npc id="41" resId="41" name="紫电士官" dir="0" width="25" height="90" pos="670,280"
                          actorPos="650,320" path="">
                <eventHandler>
                    <mouseOver>
                        <HandlerShowNpcSlogan><![CDATA[缇娜队长会好好修理你们！]]></HandlerShowNpcSlogan>

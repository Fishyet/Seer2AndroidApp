...
public class ActivityMapHandler_101 extends GrassBladeMapHandler {
    ...
    private function initNpcDefinition():XML {
        ...
        if (this._count == 1) {
            ...
            _loc1_ = <npc id="15" resId="15" name="巴卢特" dir="1" width="25" height="150" pos="680,360"
                          actorPos="670,400" path="">
                <dialog npcId="15" npcName="巴卢特" transport="1,300,400">
                    <branch id="default">
                        <node emotion="0"><![CDATA[这样软弱的精灵我不配跟随我！哼！]]></node>
                        <reply action="close" params="award"><![CDATA[回收青蜂]]></reply>
                    </branch>
                </dialog>
                <eventHandler>
                    <mouseOver>
                        <HandlerShowNpcSlogan><![CDATA[顺我者昌，逆我者亡！]]></HandlerShowNpcSlogan>
                    </mouseOver>
                </eventHandler>
            </npc>;
        } else {

...
public class QuestConfig {
    ...
    private static var _xmlClass:Class = com.taomee.seer2.app.config.QuestConfig__xmlClass;
    ...
    private static function parseQuest(param1:XML):void {
        ...
        if ((_loc15_ = param1.elements("prerequisite")).length() > 0) {
            ...
            _loc19_ = String(_loc18_ = (_loc17_ = _loc15_[0]).@questId).split(",", _loc18_.length);

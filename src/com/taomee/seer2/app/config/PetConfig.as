package com.taomee.seer2.app.config
{
   ...
   public class PetConfig
   {
      ...
      private static var _petXmlClass:Class = com.taomee.seer2.app.config.PetConfig__petXmlClass;
      
      private static var _petConfigXML:XML;
      
      private static var _dictionaryXmlClass:Class = com.taomee.seer2.app.config.PetConfig__dictionaryXmlClass;
      
      private static var _dictionaryConfigXML:XML;
      
      private static var _dialogXmlClass:Class = com.taomee.seer2.app.config.PetConfig__dialogXmlClass;

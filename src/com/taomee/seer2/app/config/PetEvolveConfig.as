package com.taomee.seer2.app.config
{
   ...
   public class PetEvolveConfig
   {
      ...
      private static var _xmlClass:Class = com.taomee.seer2.app.config.PetEvolveConfig__xmlClass;
      
      private static var _starClass:Class = com.taomee.seer2.app.config.PetEvolveConfig__starClass;
            ...
            for each(_loc2_ in _loc6_)
            {
               ...
               for each(_loc2_ in _loc10_)
               {
                  ...
                  if(uint(_loc2_.@Flag) == 0)
                  {
                     ...
                     _loc11_.name = com.taomee.seer2.app.config.ItemConfig.getItemName(_loc11_.id);
                     _loc8_.push(_loc11_);
                  }
                  else
                  {
                     ...
                     _loc11_.name = getPrefix(_loc11_.evolveLevel) + com.taomee.seer2.app.config.PetConfig.getPetDefinition(_loc11_.id).name;
                     _loc9_.push(_loc11_);
                  }
               }
               if(_loc8_)

package com.taomee.seer2.app.config
{
   ...
   public class ShopPanelConfig
   {
      ...
      private static var _class:Class = com.taomee.seer2.app.config.ShopPanelConfig__class;
      ...
      private static function entryMi(param1:Vector.<ShopItemInfo>, param2:Boolean = false) : void
      {
         ...
         for each(_loc4_ in _currXmlList.descendants("item"))
         {
            ...
            {
               _loc3_.tip = com.taomee.seer2.app.config.ItemConfig.getItemDefinition(_loc3_.referenceId).tip;
            }
      ...
      private static function entryCoins(param1:Vector.<ShopItemInfo>) : void
      {
         ...
         for each(_loc3_ in _currXmlList.descendants("item"))
         {
            ...
            {
               _loc2_.tip = com.taomee.seer2.app.config.ItemConfig.getItemDefinition(_loc2_.referenceId).tip;
            }
      ...
      public static function getCoinsEquipInfoList(param1:uint) : Vector.<ShopItemInfo>
      {
         ...
         {
            _loc3_ = com.taomee.seer2.app.config.ItemConfig.getItemDefinition(_loc5_.referenceId) as EquipItemDefinition;

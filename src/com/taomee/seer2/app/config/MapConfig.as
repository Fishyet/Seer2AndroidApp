...
public class MapConfig {
    ...
    private static var _xmlClass:Class = com.taomee.seer2.app.config.MapConfig__xmlClass;
    ...
    private static function initlize():void {
        var _loc3_:com.taomee.seer2.app.config.MapInfo = null;
        var _loc4_:XML = null;
        var _loc1_:XML = XML(new _xmlClass());
        var _loc2_:XMLList = _loc1_.child("Map");
        for each(_loc4_ in _loc2_) {
            _loc3_ = new com.taomee.seer2.app.config.MapInfo();
            _loc3_.id = _loc4_.@ID;
    ...
    public static function getMapInfo(param1:uint):com.taomee.seer2.app.config.MapInfo {
    ...
    public static function formMapNameGetMapId(param1:String):int {
        ...
        while (_loc3_ < mapMap.getValues().length) {
            if ((mapMap.getValues()[_loc3_] as com.taomee.seer2.app.config.MapInfo).name == param1) {

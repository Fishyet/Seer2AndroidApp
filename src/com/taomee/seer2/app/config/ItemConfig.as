...
public class ItemConfig {
    ...
    private static var _itemXmlClass:Class = com.taomee.seer2.app.config.ItemConfig__itemXmlClass;

    private static var _itemConfigXML:XML;

    private static var _medalXmlClass:Class = com.taomee.seer2.app.config.ItemConfig__medalXmlClass;

    private static var _medalConfigXML:XML;

    private static var _suitXmlClass:Class = com.taomee.seer2.app.config.ItemConfig__suitXmlClass;

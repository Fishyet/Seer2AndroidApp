...
public class SkillConfig {
    ...
    private static var _movesXmlClass:Class = com.taomee.seer2.app.config.SkillConfig__movesXmlClass;

    private static var _movesConfigXML:XML;

    private static var _hideMovesXmlClass:Class = com.taomee.seer2.app.config.SkillConfig__hideMovesXmlClass;

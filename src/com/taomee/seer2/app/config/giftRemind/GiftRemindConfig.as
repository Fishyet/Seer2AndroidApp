package com.taomee.seer2.app.config.giftRemind
{
   ...
   public class GiftRemindConfig
   {
      ...
      private static var _xmlClass:Class = com.taomee.seer2.app.config.giftRemind.GiftRemindConfig__xmlClass;
      ...
      private static function parserGift(param1:XML) : void
      {
         ...
         var _loc3_:com.taomee.seer2.app.config.giftRemind.VipGiftInfo = new com.taomee.seer2.app.config.giftRemind.VipGiftInfo();
      ...
      public static function getGiftInfo(param1:int) : com.taomee.seer2.app.config.giftRemind.VipGiftInfo
      {

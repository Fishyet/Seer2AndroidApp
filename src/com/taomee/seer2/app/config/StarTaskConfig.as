...
public class StarTaskConfig {
    ...
    private static var _xmlClass:Class = com.taomee.seer2.app.config.StarTaskConfig__xmlClass;
    ...
    private static function initlize():void {
        var _loc3_:XML = null;
        var _loc4_:com.taomee.seer2.app.config.StarTaskInfo = null;
        var _loc1_:XML = XML(new _xmlClass());
        var _loc2_:XMLList = _loc1_.descendants("step");
        for each(_loc3_ in _loc2_) {
            if (uint(_loc3_.@id) >= 9) {
                (_loc4_ = new com.taomee.seer2.app.config.StarTaskInfo()).module = String(_loc3_.@module);
    ...
    public static function getStarTaskInfo(param1:uint):com.taomee.seer2.app.config.StarTaskInfo {

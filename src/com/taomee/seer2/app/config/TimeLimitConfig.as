package com.taomee.seer2.app.config
{
   ...
   public class TimeLimitConfig
   {
      ...
      private static var _xmlClass:Class = com.taomee.seer2.app.config.TimeLimitConfig__xmlClass;
      ...
      {
         var _loc1_:XML = null;
         var _loc2_:com.taomee.seer2.app.config.TimeLimitInfo = null;
         var _loc3_:Vector.<com.taomee.seer2.app.config.TimeLimitDay> = null;
         var _loc4_:XML = null;
         var _loc5_:XML = null;
         _configXML = XML(new _xmlClass());
         for each(_loc1_ in _configXML.children())
         {
            _loc2_ = new com.taomee.seer2.app.config.TimeLimitInfo();
            _loc3_ = new Vector.<com.taomee.seer2.app.config.TimeLimitDay>();
      ...
      private static function initone(param1:Vector.<com.taomee.seer2.app.config.TimeLimitDay>, param2:XML) : void
      {
         var _loc3_:com.taomee.seer2.app.config.TimeLimitDay = new com.taomee.seer2.app.config.TimeLimitDay();
      ...
      public static function getFromDate(param1:uint) : Date
      {
         ...
         var _loc2_:com.taomee.seer2.app.config.TimeLimitInfo = getLimitTypeByID(param1);
         if(_loc2_)
         {
      ...
      private static function inLimitDay(param1:com.taomee.seer2.app.config.TimeLimitInfo) : Boolean
      {
         var _loc3_:Date = null;
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         ...
         var _loc8_:Date = null;
         var _loc9_:Date = null;
         var _loc2_:com.taomee.seer2.app.config.TimeLimitDay = GetLimitDay(param1.dayArr);
         if(_loc2_)
         {
            _loc3_ = new Date(TimeManager.getServerTime() * 1000);
      ...
      private static function GetLimitDay(param1:Vector.<com.taomee.seer2.app.config.TimeLimitDay>) : com.taomee.seer2.app.config.TimeLimitDay
      {

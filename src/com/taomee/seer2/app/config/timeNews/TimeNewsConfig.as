...
public class TimeNewsConfig {
    ...
    private static var _xmlClass:Class = com.taomee.seer2.app.config.timeNews.TimeNewsConfig__xmlClass;
    ...
    private static function parsePage(param1:XML):com.taomee.seer2.app.config.timeNews.PageInfo {
        var _loc4_:XML = null;
        var _loc5_:Array = null;
        var _loc6_:String = null;
        var _loc7_:com.taomee.seer2.app.config.timeNews.BtnInfo = null;
        var _loc2_:com.taomee.seer2.app.config.timeNews.PageInfo = new com.taomee.seer2.app.config.timeNews.PageInfo();
        _loc2_.id = param1.@id;
        ...
        for each(_loc4_ in _loc3_) {
            (_loc7_ = new com.taomee.seer2.app.config.timeNews.BtnInfo()).type = String(_loc4_.@type);
    ...
    public static function getPageInfo(param1:uint = 0, param2:String = ""):com.taomee.seer2.app.config.timeNews.PageInfo {
        var _loc3_:com.taomee.seer2.app.config.timeNews.PageInfo = null;

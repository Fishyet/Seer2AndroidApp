...
public class ConnectionForRelogin extends EventDispatcher {
    ...
    private static var _messageQueue:Vector.<Message>;
    ...
    public function ConnectionForRelogin() {
        super();
    }
    ...
    public static function initialize():void {
        ...
        _messageQueue = new Vector.<Message>();
        _uid = LoginInfo.account;
    }
    ...
    public static function dispose():void {
        ...
        _tempBuffer = null;
        _chunkBuffer = null;
        for each (var m:Message in _messageQueue) {
            _messageQueue.pop();
        }
        _messageQueue = null;
    }
        ...
        while (_chunkBuffer.bytesAvailable > 0) {
            if (_chunkBuffer.bytesAvailable > MSG_FIRST_TOKEN_LEN) {
                ...
                if (_loc1_ > _chunkBuffer.bytesAvailable) {
                    ...
                    _chunkBuffer.position -= MSG_FIRST_TOKEN_LEN;
                    _loc2_ = new Message(_chunkBuffer);
    ...
    private static function packHead(param1:uint, param2:ByteArray, param3:int):ByteArray {
        ...
        _loc4_.writeUnsignedInt(Message.HEAD_LENGTH + param3);

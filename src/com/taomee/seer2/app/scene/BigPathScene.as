...
package com.taomee.seer2.app.scene
{
   ...
   public class BigPathScene extends BaseScene
   {
      ...
      private function moveScreen(param1:Point) : void
      {
         ...
         if(_loc8_ < 0 && _loc8_ > -(_loc6_.width - 960) && _loc2_.x >= 960 / 2 && _loc2_.x <= _loc6_.width - 960 / 2)
         {
            _loc6_.x -= _loc4_;
            _loc7_.x -= _loc4_;
         }
         if(_loc9_ < 0 && _loc9_ > -(_loc6_.height - 560) && _loc2_.y >= 560 / 2 && _loc2_.y <= _loc6_.height - 560 / 2)
         {
            _loc6_.y -= _loc5_;
            _loc7_.y -= _loc5_;
         }

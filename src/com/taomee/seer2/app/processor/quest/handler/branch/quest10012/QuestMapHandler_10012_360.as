...
package com.taomee.seer2.app.processor.quest.handler.branch.quest10012
{
   ...
   public class QuestMapHandler_10012_360 extends BranchQuestMapHandler
   {
      ...
      private function onCloseAnimation(param1:Event) : void
      {
         ...
         var _loc2_:XML = <dialog npcId="435" npcName="稚壳鸡" transport=""><branch id="default"><node emotion="0"><![CDATA[我晕了咕……天堂的爷爷，我来见你了咕……]]></node><reply action="close" params="yes"><![CDATA[我再帮你一次！]]></reply><reply action="close" params="no"><![CDATA[你忍耐一下，我下次再来！]]></reply></branch></dialog>;

...
public class URLUtil {
    ...
    public static function getModuleRes(param1:String):String {
        ...
        return rewrite(VersionManager.getURL(_loc2_));
    }
    ...
    public static function getTeamIcon(param1:String):String {
        return rewrite(VersionManager.getURL(_resURL + "common/team/" + param1 + POSTFIX_SWF));
    }

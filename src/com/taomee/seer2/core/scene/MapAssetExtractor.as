...
public class MapAssetExtractor {
    ...
    private function parseFront():void {
        ...
        this._front.scaleX = LayerManager.root.width / 1200;
        this._front.scaleY = LayerManager.root.height / 660;
    ...
    private function parseContent():void {
        ...
        this._content.scaleX = LayerManager.root.width / 1200;
        this._content.scaleY = LayerManager.root.height / 660;
    ...
    private function parseGround():void {
        ...
        this._ground.scaleX = LayerManager.root.width / 1200;
        this._ground.scaleY = LayerManager.root.height / 660;
    ...
    private function parseFar():void {
        ...
        this._far.scaleX = LayerManager.root.width / 1200;
        this._far.scaleY = LayerManager.root.height / 660;
    ...
    private function parseSize():void {
        ...
        this._size.scaleX = LayerManager.root.width / 1200;
        this._size.scaleY = LayerManager.root.height / 660;
    ...
    public function extractPath():void {
        ...
        this._path.width = this._path.width * LayerManager.root.width / 1200;
        this._path.height = this._path.height * LayerManager.root.height / 660;

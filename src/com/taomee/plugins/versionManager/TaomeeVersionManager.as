...
public class TaomeeVersionManager {
    ...
    public static function getInstance(param1:String = "all"):TaomeeVersionManager {
        return !!_pvmDic[param1] ? _pvmDic[param1] : new TaomeeVersionManager(param1);
    }
    ...
    private function versionLoadedHandler(param1:TaomeeVersionEvent):void {
        this._fileLoader.removeEventListener(TaomeeVersionEvent.VERSION_LOADED, this.versionLoadedHandler);
    ...
    private function versionLoadErrorHandler(param1:TaomeeVersionEvent):void {
        this.endLoad();
